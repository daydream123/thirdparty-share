...
public class PermissionsFragment extends Fragment {
    ...
    private SparseArray<Permissions.OnPermissionCallback> mCallbackCache = new SparseArray<>();
  ...
  @Override
    ...
    private void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults, boolean[] shouldShowRequestPermissionRationale) {
        ...
        Permissions.OnPermissionCallback callback = getMatchedPermissionCallback(requestCode);
    ...
    void setOnPermissionCallback(Permissions.OnPermissionCallback onPermissionCallback){
        mCallbackCache.put(++mRequestCode, onPermissionCallback);
    }

    private Permissions.OnPermissionCallback getMatchedPermissionCallback(int requestCode){
        return mCallbackCache.get(requestCode);
    }
